...
var PrivateKey = require('fcash-lib').PrivateKey;
 ...
 *
 * @param {fcashBase.PrivateKey=} opts.commitmentKey - key to use when negotiating the channel
 *
 ...
 *
 * @param {fcashBase.PrivateKey=} opts.fundingKey - key to use for funding the channel
 ...
 * @return {fcashBase.Transaction} the updated transaction
 */
