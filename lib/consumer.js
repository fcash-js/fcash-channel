 ...
 *
 * @param {fcore.PrivateKey=} opts.commitmentKey - key to use when negotiating the channel
 *
 ...
 *
 * @param {fcore.PrivateKey=} opts.fundingKey - key to use for funding the channel
 ...
 * @return {fcore.Transaction} the updated transaction
 */
